            ...
            <div id="panel-2" class="panel">
                <div class="panel-container collapse show">
                    ...
                    <div class="panel-content">
                        <form action="{{url('admins/currencies')}}" method="POST" enctype="multipart/form-data" novalidate>
                            @csrf
                            <div class="row mb-2">
                                <div class="col-md-6 mb-2">
                                    ...
                                    <option value="USD">@lang('lang.usd')</option>
                                    <option value="Riel">@lang('lang.riel')</option>
                                    </select>
                                </div>
                                <div class="col-md-6 mb-2">
                                    <label class="form-label" for="single-default">@lang('lang.amount_usd') <span class="text-danger">*</span></label>
                                <input type="number" id="amount_usd" name="amount_usd" class="form-control" value="">
                                </div>
                            </div>
                            <div class="row mb-2">
                                    <div class="col-md-6 mb-2">
                                        <label class="form-label" for="single-default">@lang('lang.amount_riel') <span class="text-danger">*</span></label>
                                    <input type="number" id="amount_riel" name="amount_riel" class="form-control" value="">
                                    </div>
                                <div class="col-md-6 mb-2">
                                    <label class="form-label" for="exchange_date">@lang('lang.exchange_date') <span class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <input type="text" id="exchange_date" name="exchange_date" class="form-control exchange_date_disabled datepicker exchange_date_required" value="">
