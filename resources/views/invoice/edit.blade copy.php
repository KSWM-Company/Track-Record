...
@section('content')
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{url('admins/company-info')}}">@lang('lang.company_info')</a></li>
                                ...
                                <div class="col-md-4" style="display: flex;justify-content: center;">
                                    <div class="col-md-6">
                                        <div class="form-group mt-1">
                                            ...
                                            @else
                                                <img src="{{ asset('/images/profilesstaff/'.$data->company_logo) }}" class=" imagestaff_preview shadow-3 img-thumbnail " alt="article photo" style="width: 150px;height:150px;border-radius: 50%;border: 1px solid #08ff67;">
                                            @endif
                                        </div>
