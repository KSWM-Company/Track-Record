            ...
            <div id="panel-2" class="panel">
                <div class="panel-container collapse show">
                    ...
                    <div class="panel-content">
                        <form action="{{url('admins/province')}}" method="POST" enctype="multipart/form-data" novalidate>
                            @csrf
                            <div class="row mb-2">
                                <div class="col-md-4 mb-2">
                                    <label class="form-label" for="district_code">@lang('lang.district_code') <span class="text-danger">*</span></label>
                                    <input type="number" id="district_code" name="district_code" class="form-control @error('name') is-invalid @enderror" value="">
                                </div>
                                <div class="col-md-4 mb-2">
                                ...
                                <div class="col-md-6 mb-2">
                                    <label class="form-label" for="village">@lang('lang.village')</label>
                                    <input type="text" id="village" name="village" class="form-control @error('unit') is-invalid @enderror" value="">
                                </div>
                                <div class="col-md-6 mb-2">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-12">
                                    <div class="" style="text-align: right;">
                                        <a href="{{url('admins/province')}}" class="btn btn-outline-secondary btn-pills waves-effect waves-themed">@lang('lang.cancel')</a>
