<div id="BusinessTypeModal" class="modal custom-modal fade" style="display: none;" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">@lang('lang.import_business_type')</h6>
    ...
    $(document).ready(function() {
        ...
        $(".submit-btn").on("click", function(e) {
            ...
            if (fileExtension == "xls" || fileExtension == "xlsx" || fileExtension == "csv" && fileSize < 1048576) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ url("/admins/business/type/import") }}',
                    data: form_data,
                    ...
                    success: function (data) {
                        if (data.mg == "success") {
                            ...
                            Swal.fire("Success!", "Your file has been imported successfully.","success");
                            window.location.reload();
                        } else {
                            // Display error message if import fails
                            Swal.fire("Error!", "There was an error importing the file. Please try again.","error");
                            window.location.reload();
                        }
                    },
