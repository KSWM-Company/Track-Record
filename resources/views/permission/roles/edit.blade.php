                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('role_type') is-invalid @enderror" id="role_type" name="role_type">
                                            ...
                                            <option value="Manager" {{$role->role_type=='Manager' ? 'selected' : ''}}>Manager</option>
                                            ...
                                            <div class="card border-success">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    @foreach ($permission as $item)
                                                        <div class="mb-1">
                                                            <div class="custom-control custom-checkbox custom-control-inline">
                                                                <input type="checkbox" name="permission[]" class="custom-control-input check_all ch_all_{{ $cate->id }}" id="defaultInline_{{ $item->id }}" value="{{ $item->id }}" {{ in_array($item->id, $rolePermissions) ? 'checked' : '' }}>
